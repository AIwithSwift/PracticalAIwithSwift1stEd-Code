...
|Chapter13-Recommender| ⛔️ | ⛔️ | To be made by Mars. Model retraining to be discussed in this, [it seems quite fiddly](https://developer.apple.com/documentation/coreml/mlupdatetask). Potential dataset [here](https://grouplens.org/datasets/hetrec-2011/).  |
|Chapter14-DrawingDetector | ✴️ | ⛔️ | Apps having models tweaked by Mars. Awaiting write-up with Paris. |
